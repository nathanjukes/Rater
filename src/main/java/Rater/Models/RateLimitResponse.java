...
public class RateLimitResponse {
    ...
    public static RateLimitResponse from(API api, APIStatus apiStatus) {
        return new RateLimitResponse(
                api.getName(),
                api.getFlatStructure(),
                apiStatus.getExceeded(),
                apiStatus.getApiLimit(),
                apiStatus.getCurrentLoad()
        );
    }
}
